...
| `id` | `string` | Unique UUID for the library |
| `name` | `string` | Display name of the library |
| `settings` | `object` | User-configurable options including thumbnail quality and sync preferences |
| `statistics` | `object` | Cached counts and sizes for quick display |
