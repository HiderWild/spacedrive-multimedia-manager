...
See [Proxy Pairing](/core/proxy-pairing) for the full protocol, resource model, and flows.
...
- [Networking](/core/networking) - Network transport details
- [Devices](/core/devices) - Device management system
- [Proxy Pairing](/core/proxy-pairing) - Vouching based pairing flow
- [Security](/core/security) - Cryptographic architecture
