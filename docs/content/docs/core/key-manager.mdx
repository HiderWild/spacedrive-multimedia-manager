...
- [Devices](/core/devices) - Device identity and pairing
- [Networking](/core/networking) - P2P communication using session keys
- [Cloud Integration](/core/cloud-integration) - Cloud credential storage
- [Security](/core/security) - Overall security architecture
