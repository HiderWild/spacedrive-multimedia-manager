...
Learn more about building extensions in the [Spacedrive Developer SDK](/extensions/introduction) documentation.

## Next Steps

Understanding the architecture provides the foundation for working with Spacedrive. Explore these topics next:

- [Libraries](/core/libraries) - How Spacedrive organizes your data
- [Networking](/core/networking) - Peer-to-peer communication details
- [Sync](/core/sync) - Multi-device synchronization protocols
