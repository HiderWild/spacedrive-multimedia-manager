...
<Callout type="info">See `core/tests/sync_backfill_test.rs`, `core/tests/sync_realtime_test.rs`, and `core/tests/sync_metrics_test.rs` for the test suite.</Callout>
...
<Callout type="info">Extension sync framework is ready. SDK integration pending.</Callout>
...
- [Devices](/core/devices) - Device pairing and management
- [Networking](/core/networking) - Network transport layer
- [Libraries](/core/libraries) - Library structure and management
