...
| ORG-BUILD-00B-PW | Wire PowerShell start/run/restart/cache entry points | ORG-BUILD-00A | In Flight | Turing | PowerShell files staged in shared integration tree; candidate commit/report pending |
| ORG-BUILD-00B-SH | Wire justfile, Tauri package, and shell Cargo entry points | ORG-BUILD-00A | Candidate | Feynman | Candidate `176d3881b0e5d64d5126d33d4a06663429b40d4e`; shell fixture and static checks reported passing; coordinator verification pending |
