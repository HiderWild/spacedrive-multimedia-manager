...
| ORG-BE-03 | Task create, list, get, snapshot scan, and change-scan operations | ORG-BE-01, ORG-BE-02 | Core organize operation and scanner files | In Flight | coordinator + implementation agent | Dependencies merged; implementation dispatch follows this board update |
