...
| ORG-BE-02 | SQLite migration, entities, task repository, and persistence tests | ORG-BE-01, ORG-BUILD-00, ORG-BUILD-BASELINE | Core migration and organize persistence files only | Review | Gauss | `bc69c18b2` plus compile repair `deae21ca8`; full Windows wrapper `check -p sd-core -j 2` passes; dedicated repository integration test remains |
