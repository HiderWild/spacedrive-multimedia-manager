...
| ORG-BE-02 | SQLite migration, entities, task repository, and persistence tests | ORG-BE-01, ORG-BUILD-00, ORG-BUILD-BASELINE | Core migration and organize persistence files only | In Flight | Gauss | `bc69c18b2` plus `deae21ca8`; crate check passes, but dedicated test is 2/8 and final review found 10 P1 contract gaps; insertion ID failure and repository semantics are being repaired |
