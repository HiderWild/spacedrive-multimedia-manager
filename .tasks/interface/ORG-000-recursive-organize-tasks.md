...
| ORG-BUILD-00B-R | Wire residual user-facing compile entrypoints and repository-wide bypass checks | ORG-BUILD-00B-PW, ORG-BUILD-00B-SH | In Flight | Unassigned | P1 residuals: packages/ts-client generate-types, .vscode clippy/run tasks, scripts/autoformat.sh clippy --fix; route through policy and add bounded static coverage |
