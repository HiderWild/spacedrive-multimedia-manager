...
| ORG-BUILD-00B-PW | Wire PowerShell start/run/restart/cache entry points | ORG-BUILD-00A | In Flight | Turing/Socrates | Tauri chain is closed, but final quality review found residual direct compile entrypoints outside the original lane; expand repository wiring and static coverage before re-review |
| ORG-BUILD-00B-SH | Wire justfile, Tauri package, and shell Cargo entry points | ORG-BUILD-00A | In Flight | Feynman/Socrates | Tauri chain is closed, but final quality review found residual direct compile entrypoints in ts-client, VS Code tasks, and autoformat; expand repository wiring and static coverage before re-review |
| ORG-BUILD-00B-R | Wire residual user-facing compile entrypoints and repository-wide bypass checks | ORG-BUILD-00B-PW, ORG-BUILD-00B-SH | Review | coordinator | Candidate `f0c140746`; 9/9 bounded fixture checks, Bash syntax, JSON/JSONC parse, PowerShell fixture/AST, residual bypass scan, and diff check passed; independent quality re-review remains before ORG-BUILD-00C can unblock |
| ORG-BUILD-00C | Independent policy review and fixture verification | ORG-BUILD-00B-PW, ORG-BUILD-00B-SH, ORG-BUILD-00B-R | Blocked | Unassigned | Waiting for residual entrypoint wiring and re-review |
