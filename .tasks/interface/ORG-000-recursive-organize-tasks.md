...
| --- | --- | --- | --- | --- | --- |
| ORG-BUILD-00A | Test-first safe artifact discovery/cleanup, shared target resolver, wrapper, and policy documentation | ORG-BUILD-00A-FIX2 | In Flight | Archimedes | Quality review found P1 stdout/exit-code corruption and reparse TOCTOU; both require RED/GREEN fixes |
| ORG-BUILD-00A-R | Recover ORG-BUILD-00A from any residual worktree and finish the minimal policy slice | ORG-BUILD-00A | In Flight | Archimedes | Same implementer is applying the two P1 corrections; candidate remains unaccepted |
