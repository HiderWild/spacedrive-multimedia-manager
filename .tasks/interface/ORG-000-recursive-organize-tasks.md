...
| --- | --- | --- | --- | --- | --- |
| ORG-BUILD-00A | Test-first safe artifact discovery/cleanup, shared target resolver, wrapper, and policy documentation | ORG-BUILD-00A-FIX | Review | quality reviewer pending | Spec review approved; entering independent code-quality review |
