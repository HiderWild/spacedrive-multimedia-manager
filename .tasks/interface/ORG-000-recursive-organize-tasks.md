...
| ORG-BE-02 | SQLite migration, entities, task repository, and persistence tests | ORG-BE-01, ORG-BUILD-00, ORG-BUILD-BASELINE | Core migration and organize persistence files only | In Flight | Gauss | `bc69c18b2`, `deae21ca8`, `143b33c160`; UUID insertion regression now passes, original suite was 2/8 before repair, and final review found 10 P1 contract gaps still being repaired |
