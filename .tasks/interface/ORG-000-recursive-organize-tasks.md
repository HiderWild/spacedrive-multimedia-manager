...
| ORG-BE-02 | SQLite migration, entities, task repository, and persistence tests | ORG-BE-01, ORG-BUILD-00, ORG-BUILD-BASELINE | Core migration and organize persistence files only | Blocked | Unassigned | Depends on ORG-BE-01 public model/error contracts and baseline compile repair |
